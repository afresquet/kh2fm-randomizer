...
export const cavernOfRemembranceEnemyLocations: EnemyLocation[] = [
	{
	...
	},
	{
		...
		enemies: [
			...
			{
				enemy: Enemies.SPRING_METAL,
				value: "11C5BC9C",
			},
			{
				enemy: Enemies.RUNEMASTER,
				value: "11C5BCDC",
			},
			{
				enemy: Enemies.SPRING_METAL,
